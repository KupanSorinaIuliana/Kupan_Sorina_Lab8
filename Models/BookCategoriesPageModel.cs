...
namespace Kupan_Sorina_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Kupan_Sorina_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Kupan_Sorina_Lab8Context context,
